...
\begin{enumerate}
  ...
  \begin{align*}
    ...
    &= -\left((1+X (kE))\sinh(kE T)dT + \cosh(kE T) dX\right)^2 + \left((1 + X(kE))\cosh(kE T) dT + \sinh(kE T) dX\right)^2 + d\rho^2 + \rho^2d\varphi^2\\
    &= -(1+X (kE))^2\sinh^2(kE T)dT^2 - \cosh^2(kE T) dX^2 + (1 + X(kE))^2\cosh^2(kE T) dT^2 + \sinh^2(kE T) dX^2 + d\rho^2 + \rho^2d\varphi^2
  \end{align*}
\end{enumerate}
